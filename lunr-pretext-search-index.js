...
},
{
  ...
  "number": "12.3.81",
  "title": "",
  "body": " The methane molecule consists of a carbon molecule bounded to four hydrogen molecules bonded to four hydrogen molecules that are spaced as far apart from each other as possible. The hydrogen atoms then sit at the vertices of a tetrahedron, with the carbon atom at its center, as shown in the figure below. We can model this with the carbon atom at the point and the hydrogen atoms at , , , and . Use the dot product to find the bond angle formed between any two of the line segments from the carbon atom to the hydrogen atoms.    A Methane molecule   "
},
{
  "id": "ws-sec123-13",
  "level": "2",
