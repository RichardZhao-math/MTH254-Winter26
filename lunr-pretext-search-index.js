...
},
{
  ...
  "number": "14.6.19",
  "title": "",
  "body": " A baseball player hits the ball and then runs down the first base line at 20 ft\/s. The first baseman fields the ball and then runs toward first base along the second base line at 18 ft\/s as shown in the figure below.     Determine how fast the distance between the two players is changing at a moment when the hitter is 8 ft from first base and the first baseman is 6 ft from first base.   To find the rate of change of with respect to , we need a function first. Based on the diagram, observe that , , and form a right triangle, which implies that In addition, both and are functions of time , so we can let and .  Then how do we determine ... The answer is to use the Chain Rule!   "
},
{
  "id": "ws-sec146-7",
  "level": "2",
